def main():
    ...
    intCodeCopy = [1,0,0,3,1,1,2,3,1,3,4,3,1,5,0,3,2,6,1,19,1,5,19,
    ...
    2,13,119,123,1,9,123,127,1,5,127,131,2,131,6,135,1,135,
    5,139,1,139,6,143,1,143,6,147,1,2,147,151,1,151,5,0,99,2,14,0,0]

    intCode = intCodeCopy.copy()
